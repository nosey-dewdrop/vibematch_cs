...
public class AdminPanel extends JPanel {
    ...
    public void refresh(){
        ...
        for (int i = 0; i < frame.all_communities.size(); i++) {
            Community c = frame.all_communities.get(i);
            ...
            delet_button.setForeground(Color.RED);
            delet_button.setFocusable(false);
            delet_button.addActionListener(e -> {
                // TODO: should call controller/AdminController.deleteCommunity() ->
                // model/Administrator.deleteCommunity() eventually, this just edits
                // the view-layer demo list directly for now
                frame.all_communities.remove(c);
                frame.my_communities.remove(c); // also kick it from joined lists
                //System.out.println("deleted " + c.get_name());
                refresh();
            });
